# -*- coding: utf-8 -*-
"""
Created on Sun May 24 10:39:59 2020
...
titanic_train = pd.read_csv("D:\\Data Science\\Code Exec\\Data\\Titanic\\titanic_train.csv")
...
graph.write_pdf("D:\\Data Science\\Code Exec\\tree.pdf")

#read test data
titanic_test = pd.read_csv("D:\\Data Science\\Code Exec\\Data\\titanic\\titanic_test.csv")
...
titanic_test.to_csv("D:\\Data Science\\Code Exec\\submission.csv", columns=["PassengerId", "Survived"], index=False)