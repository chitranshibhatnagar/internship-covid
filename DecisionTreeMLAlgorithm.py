...
graph.write_pdf("D://Data Science//tree.pdf")

#read test data
titanic_test = pd.read_csv("D:\\Data Science\\Code Exec\\Data\\Titanic\\titanic_test.csv")
print(titanic_test.info())
X_test = titanic_test[features]
titanic_test['Survived'] = classifer.predict(X_test)
titanic_test.to_csv("D:\\Data Science\\Code Exec\\Data\\Titanic\\titanic_submission.csv", columns=["PassengerId", "Survived"], index=False)
