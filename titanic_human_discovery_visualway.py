...
titanic_test = pd.read_csv("D:\\Data Science\\Code Exec\\Data\\titanic_test.csv")
print(titanic_test.shape)

titanic_test['Survived'] = 0
titanic_test['test'] = 23
titanic_test.loc[titanic_test.Sex=='female', ['Sex','Survived']]
titanic_test.to_csv("D:/Data Science/submission1.csv",columns=['PassengerId','Survived','test'], index=False)
#bi variate plots
